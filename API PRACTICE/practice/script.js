...
const array = JSON.parse(JSON.stringify(data)); // it convert to proper array format....
console.log(array);
...
function pushValidate(object) {
  if (!object.id || !object.name || !object.faculty) {
    alert("please fill the full required details");
  } else {
    data.push({
      id: object.id,
      name: object.name,
...
// console.log(details);
// let array1 = JSON.parse(JSON.stringify(details));
// console.log(array1);

// console.log(Object.values(details));
// console.log(typeof details);
// let { id, name, faulty } = Object.values(details);
// console.log(id);
